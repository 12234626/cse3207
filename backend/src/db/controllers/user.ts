...
function createUser(req: Request, res: Response) {
  ...
  const query =
    "INSERT INTO user_table (id, name, password, department, phone) VALUES (:id, :name, :password, :department, :phone)";
...
export { getUser, checkUserPassword, createUser, updateUser, deleteUser };
