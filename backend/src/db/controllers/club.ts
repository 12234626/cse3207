...
function createClub(req: Request, res: Response) {
  ...
  const query = "INSERT INTO club_table (name, type, field, admin, inrecruitment, introduction) VALUES (:name, :type, :field, :admin, :inrecruitment, :introduction) RETURNING id";
